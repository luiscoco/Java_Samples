...
public class SynchronizedListTutor {
    ...
    // Use a thread-safe list to avoid concurrent modification issues during adds
    ...
    public static void main(String[] args) {
        new SynchronizedListTutor().runTest();
    }
    ...
    public void runTest() {
        ...
        if (failed) {
            System.out.println("Result: FAILED (exceptions occurred)");
        } else {
            System.out.println("Result: OK (no exceptions)");
        }
